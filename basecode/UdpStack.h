...
public:
	...
	bool init( const Data& server, uint16 clientPort=0, uint16 servPort=0,
	...
	*/
	...
	/** 发送数据包 **/
	int transmit ( const void* data, uint32 len, long millsecond=-1 );
	...
	bool doClient ( const Data& server, uint16 port );
